...
return <Table heads={["#", "Squad", "Tag", "Pontos", "Kills", "Partidas", "Média", "Aprov. %", "TOP 1", "Camp."]} rows={ranking.map((r,i)=>[String(i+1), r.squad, r.tag, String(r.points), String(r.kills), String(r.matches), String(r.avg), String(r.aproveitamento) + "%", String(r.top1), String(r.campeonatos)])} />
}
